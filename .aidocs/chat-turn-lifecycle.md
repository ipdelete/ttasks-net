...
5. Full-tool capabilities run a tool-authoring prompt to create or reuse task-library templates.
...
10. A final prompt task summarizes upstream outputs.
11. Graph/task state and results persist to SQLite.
